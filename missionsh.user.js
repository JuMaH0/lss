...
var mission=$('[id^=mission_panel_heading_]');var x;var mission_count=mission.length;for(x=0;x<mission_count;x++){var count_default=document.getElementById("mission_list").getElementsByClassName("panel-default").length;var count_red=document.getElementById("mission_list").getElementsByClassName("mission_panel_red").length;var count_yellow=document.getElementById("mission_list").getElementsByClassName("mission_panel_yellow").length;var count_green=count_default-count_yellow-count_red;console.log(count_green);if(count_red>99){document.getElementById('red_circle').innerHTML='∞';}else{document.getElementById('red_circle').innerHTML=''+count_red+'';}
