...
if(paramedicchecked==='checked'&&needrd[0]!=undefined||paramedicchecked==='checked'&&hassumpatient!=undefined){firstChild[1].style.display='block'}
if(patientschecked==='checked'&&haspatient[0]!=undefined){firstChild[1].style.display='block'}}}}})();
